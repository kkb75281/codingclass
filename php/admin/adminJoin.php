                    ...
                    <fieldset>
                        ...
                        <div class="join__box">
                            ...
                            <div>
                                ...
                                <input type="text" id="youBirth" name="youBirth" maxlength="15"  placeholder="YYYY-MM-DD" required>
                                <p class="msg" id="youBirthComment"><!-- * 형식이 맞지 않습니다.(YYYY-MM-DD) --></p>
                            </div>
                            <div>
                                <label for="youPassC">휴대폰 번호</label>
                                <input type="text" id="youPhone" name="youPhone" maxlength="15" placeholder="010-0000-0000" required>
                                <p class="msg" id="youPhoneComment"><!-- * 형식이 맞지 않습니다.(010-0000-0000) --></p>
                            </div>
                        </div>
                        <button class="join__btn" type="submit">회원가입 하기</button>
                    </fieldset>
                </form>
            </div>
        </section>
